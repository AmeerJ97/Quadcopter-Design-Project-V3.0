...
extern int pad_speed;           //PS3 Pad speed control
...
/*------------------- State Variables-------------------*/
extern int quad_state;         //State control variable
extern int flag;               //flag to turn off PID set variables
#endif
