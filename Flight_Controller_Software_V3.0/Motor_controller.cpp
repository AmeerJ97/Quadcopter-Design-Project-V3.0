...
int pad_speed = 0;                //Speed control for the PS3 button pad
...
void Motor_class::e_Driver() {
  if (!motorFlag && stopMotors) {
    mESC1 = 1000;
    mESC2 = 1000;
    mESC3 = 1000;
    mESC4 = 1000;

  } else if (motorFlag && !stopMotors) {
